...
namespace Cob.Regressivo.CLI.Templating;

public static class TemplateEngine
{
    public static string Render(string template, Core.PipelineExecutionContext context)
    {
        // Allow {{$correlationId}} as alias for {{correlationId}}
