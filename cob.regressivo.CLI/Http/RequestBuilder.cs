...
using Cob.Regressivo.CLI.Templating;
using Flurl;
using Newtonsoft.Json.Linq;

namespace Cob.Regressivo.CLI.Http;
...
{
    public static BuiltRequest Build(StepConfig step, Core.PipelineExecutionContext context)
    {
